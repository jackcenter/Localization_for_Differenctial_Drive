...
from dynopy.dataobjects.state import InformationEstimate
from dynopy.estimationtools.tools import DiscreteLinearStateSpace
...
def run(target_state_space: DiscreteLinearStateSpace, state: InformationEstimate, measurement: Measurement,
    ...
    return InformationEstimate(step, i_k1_p, I_k1_p)
